        ...
        steps = [
            {
                ...
                "description": "Review cash flow, balance sheet, and P&L statements to establish baseline.",
            ...
            },
            {
                ...
                "description": "Clarify short-term and long-term financial goals, risk tolerance, and return expectations.",
            ...
            },
            {
                ...
                "description": "Evaluate available investment vehicles, historical performance, and market conditions.",
                "estimated_effort": "5 days",
                "dependencies": [2],
            },
            {
                "step_number": 4,
                "title": "Develop Budget Allocation",
                "description": "Allocate capital across selected investments with diversification strategy.",
            ...
            },
            {
                ...
                "description": "Execute purchases, set up monitoring, and document the investment plan.",
                "estimated_effort": "2 days",
                "dependencies": [4],
            },
            {
                ...
                "description": "Set up periodic performance reviews and rebalancing triggers.",
                "estimated_effort": "1 day",
                "dependencies": [5],
            },
        ]
        ...
        steps = [
            {
                ...
                "description": "Document technical requirements, constraints, and success criteria.",
                "estimated_effort": "3 days",
                "dependencies": [],
            },
            {
                ...
                "description": "Design system architecture, select technology stack, and create migration/deployment blueprint.",
                "estimated_effort": "5 days",
                "dependencies": [1],
            },
            {
                ...
                "description": "Provision development, staging, and production environments.",
                "estimated_effort": "2 days",
                "dependencies": [2],
            },
            {
                ...
                "description": "Build and configure the solution according to architecture design.",
            ...
            },
            {
                ...
                "description": "Run unit, integration, and user acceptance tests.",
                "estimated_effort": "5 days",
                "dependencies": [4],
            },
            {
                ...
                "description": "Deploy to production, verify functionality, and monitor initial performance.",
                "estimated_effort": "2 days",
                "dependencies": [5],
            },
        ]
        ...
        steps = [
            {
                ...
                "description": "Survey existing research, publications, and related work in the domain.",
            ...
            },
            {
                ...
                "description": "Formulate clear, testable hypotheses and research questions.",
                "estimated_effort": "2 days",
                "dependencies": [1],
            },
            {
                ...
                "description": "Select research methods, data collection techniques, and analysis framework.",
                "estimated_effort": "3 days",
                "dependencies": [2],
            },
            {
                ...
                "description": "Gather data according to the methodology, ensuring quality and completeness.",
            ...
            },
            {
                "step_number": 5,
                "title": "Data Analysis",
                "description": "Process and analyze collected data using selected techniques.",
                "estimated_effort": "7 days",
                "dependencies": [4],
            },
            {
                ...
                "description": "Interpret findings, draw conclusions, and prepare research report.",
                "estimated_effort": "5 days",
                "dependencies": [5],
            },
        ]
        ...
        steps = [
            {
                ...
                "description": "Clearly define project scope, objectives, deliverables, and success criteria.",
                "estimated_effort": "2 days",
                "dependencies": [],
            },
            {
                ...
                "description": "Identify required resources, team members, tools, and budget.",
                "estimated_effort": "2 days",
                "dependencies": [1],
            },
            {
                "step_number": 3,
                "title": "Create Work Breakdown",
                "description": "Break the work into manageable tasks and milestones.",
                "estimated_effort": "3 days",
                "dependencies": [2],
            },
            {
                "step_number": 4,
                "title": "Execution",
                "description": "Execute tasks according to the plan, tracking progress against milestones.",
            ...
            },
            {
                "step_number": 5,
                "title": "Review & Adjust",
                "description": "Review outcomes against objectives, adjust approach as needed.",
                "estimated_effort": "2 days",
                "dependencies": [4],
            },
        ]
        ...
        if provider_cfg:
            ...
            try:
                return await self._llm_plan(
                    goal, constraints, context, detail_level, max_steps, provider_config
                )
    ...
    async def _llm_plan(
        ...
        response = await client.chat_completion(
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"Generate a {detail_level} plan for: {goal}",
                },
            ],
