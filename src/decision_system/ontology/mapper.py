...
DEFAULT_CONCEPTS: list[OntologyConcept] = [
    OntologyConcept(
        ...
        name="Revenue",
        concept_type="metric",
        description="Gross or net revenue",
    ...
    OntologyConcept(
        ...
        name="Profit Margin",
        concept_type="metric",
        description="Gross or net profit margin",
        aliases=["gross_margin", "net_margin"],
    ),
    OntologyConcept(
        concept_id="product",
        name="Product",
    ...
    OntologyConcept(
        ...
        name="Customer",
        concept_type="entity",
        description="Customer or consumer",
    ),
    OntologyConcept(
        concept_id="customer_segment",
        name="Customer Segment",
        concept_type="entity",
        description="Customer segment / tier / vertical",
        aliases=["segment", "tier"],
    ),
    OntologyConcept(
        concept_id="customer_lifetime_value",
        name="Customer Lifetime Value",
        concept_type="metric",
        description="Customer CLV / LTV",
        aliases=["lifetime_value", "ltv", "clv"],
    ),
    OntologyConcept(
        concept_id="city",
        name="City",
    ...
    OntologyConcept(
        concept_id="sales_amount",
        name="Sales Amount",
        concept_type="metric",
        description="Sales transaction amount",
    ),
    OntologyConcept(
        concept_id="lead_source",
        name="Lead Source",
        concept_type="signal",
        description="Marketing lead / traffic source",
        aliases=["channel", "traffic_source", "source_channel"],
    ),
    OntologyConcept(
        concept_id="marketing_channel",
        name="Marketing Channel",
        concept_type="signal",
        description="Marketing channel name",
    ),
    OntologyConcept(
        concept_id="marketing_spend",
        name="Marketing Spend",
        concept_type="metric",
        description="Marketing spend / ad spend",
    ),
    OntologyConcept(
        concept_id="click_count",
        name="Click Count",
        concept_type="metric",
        description="Number of clicks",
    ),
    OntologyConcept(
        concept_id="conversion_count",
        name="Conversion Count",
        concept_type="metric",
        description="Number of conversions / leads / purchases",
    ),
    OntologyConcept(
        concept_id="conversion_rate",
        name="Conversion Rate",
        concept_type="metric",
        description="Conversion rate (decimal)",
        aliases=["conversion_rate_pct"],
    ),
    OntologyConcept(
        concept_id="bounce_rate",
        name="Bounce Rate",
        concept_type="signal",
        description="Bounce rate (decimal)",
        aliases=["bounce_rate_pct"],
    ),
    OntologyConcept(
        concept_id="refund_requested",
        name="Refund Requested",
        concept_type="signal",
        description="Whether a refund was requested",
    ),
    OntologyConcept(
        concept_id="sentiment",
        name="Sentiment",
        concept_type="signal",
        description="Feedback sentiment",
    ),
    OntologyConcept(
        concept_id="complaint_issue",
        name="Complaint Issue",
        concept_type="signal",
        description="Type of complaint / issue",
        aliases=["issue_type", "problem_type", "ticket_type"],
    ),
    OntologyConcept(
        concept_id="competitor_price",
        name="Competitor Price",
        concept_type="metric",
        description="Competitor's price",
    ),
    OntologyConcept(
        concept_id="our_price",
        name="Our Price",
        concept_type="metric",
        description="Our / company price",
        aliases=["company_price", "list_price"],
    ),
    OntologyConcept(
        concept_id="review_score",
        name="Review Score",
        concept_type="metric",
        description="Competitor or product review score",
        aliases=["rating", "review_rating"],
    ),
    OntologyConcept(
        concept_id="operational_delay",
        name="Operational Delay",
        concept_type="metric",
        description="Average delay in days",
        aliases=["delay_days", "avg_delay"],
    ),
    OntologyConcept(
        concept_id="bottleneck",
        name="Bottleneck",
        concept_type="risk",
        description="Process bottleneck flag",
        aliases=["is_bottleneck"],
    ),
    OntologyConcept(
        concept_id="strategic_goal",
        name="Strategic Goal",
        concept_type="entity",
        description="Strategic initiative or goal",
        aliases=["objective", "initiative", "goal"],
    ),
    OntologyConcept(
        concept_id="constraint",
        name="Constraint",
        concept_type="risk",
        description="Constraint or blocker",
    ),
    OntologyConcept(
        concept_id="owner",
        name="Owner",
        concept_type="entity",
        description="Person or team who owns something",
        aliases=["owned_by", "lead", "responsible"],
    ),
    OntologyConcept(
        concept_id="dependency",
        name="Dependency",
        concept_type="relationship",
        description="Technical or business dependency",
    ),
    OntologyConcept(
        concept_id="contradiction",
        name="Contradiction",
        concept_type="risk",
        description="Contradictory statement or decision",
    ),
    OntologyConcept(
        concept_id="risk",
        name="Risk",
        concept_type="risk",
        description="Generic risk signal",
        aliases=["risk_factor"],
    ),
    OntologyConcept(
        ...
        name="Time Period",
        concept_type="signal",
        description="Date, month, period, or time dimension",
        aliases=["month", "date", "period", "signup_month", "date_month"],
    ),
    OntologyConcept(
        concept_id="page",
        name="Page",
        concept_type="entity",
        description="Web page or landing page",
        aliases=["page_path", "url", "landing_page"],
    ),
    OntologyConcept(
        concept_id="session_count",
        name="Session Count",
        concept_type="metric",
        description="Number of sessions or visits",
        aliases=["sessions", "page_sessions", "visits"],
    ),
    OntologyConcept(
        concept_id="traffic_source",
        name="Traffic Source",
        concept_type="signal",
    ...
    OntologyConcept(
        concept_id="competitor",
        name="Competitor",
        concept_type="entity",
        description="Competitor name or entity",
    ),
    OntologyConcept(
        concept_id="process",
        name="Process",
        concept_type="entity",
        description="Business process or operation name",
        aliases=["operation", "process_name"],
    ),
    OntologyConcept(
...
COLUMN_RULES: list[tuple[str, str]] = [
    ...
    ("period", "time_period"),
    ("date", "time_period"),
    ("date_month", "time_period"),
    ("signup_month", "time_period"),
    ("page", "page"),
    ("page_path", "page"),
    ("url", "page"),
    ("landing_page", "page"),
